      ...
      <section className="py-24 bg-[#ffffff]">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">Founded in 2009, DALAN Builders has grown from a small development firm into one of Varanasi's most respected companies. Our journey has been defined by a commitment to quality, innovation, and customer satisfaction.</p>
            <p className="text-gray-600 leading-relaxed mb-4">We have successfully delivered over 120 projects spanning luxury apartments, commercial complexes, retail spaces, and gated communities. Every property we develop carries our promise of superior construction and timely delivery.</p>
          ...
          <div className="relative reveal">
            ...
            <div className="absolute -bottom-6 -left-6 bg-[#F26522] rounded-2xl p-6 text-black">
              <div className="text-3xl font-display font-bold">120+</div>
              <div className="text-xs uppercase tracking-wide text-black/80">Projects Delivered</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#ffffff]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((v, i) => (
              <div key={i} className="bg-[#F7F7F7] border border-black/10 rounded-2xl p-8 reveal hover:border-[#F26522]/40 transition-all duration-300">
