          ...
          <div className="lg:col-span-6 flex flex-col">
            ...
            <div className="bg-[#091e44] rounded-3xl p-6 text-white flex flex-wrap md:flex-nowrap items-center justify-between gap-6 shadow-xl border border-white/5">
              <div className="text-left max-w-xs">
                ...
                <strong className="text-base md:text-lg block mt-0.5">Whatsapp Us</strong>
              </div>
              <div className="flex flex-wrap gap-4 items-center justify-center shrink-0">
                <Link
                  href="/contact"
                  className="bg-[#C9922A] text-white px-7 py-3 rounded-full text-sm font-semibold tracking-wide shadow-lg shadow-[#C9922A]/10 transition-all duration-300 hover:bg-[#a6741b] hover:shadow-[#C9922A]/20 hover:-translate-y-0.5 inline-flex items-center gap-2"
                >
                  Enquire Now
                </Link>
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-[#25D366] px-8 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#20ba5a] hover:shadow-lg hover:shadow-green-500/30 gap-2 shrink-0"
                >
