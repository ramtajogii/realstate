...
const projects = [
  ...
  { id: 'dalan-residency', title: 'DALAN RESIDENCY', location: 'Village Lodhan, near Om Villas, Chandmari, Varanasi', type: 'Residential', status: 'Delivered', beds: '3 BHK Duplex Row House', price: 'Contact for Price', img: '/images/residency-card.jpg' },
