  ...
  return (
    <div className="bg-white min-h-screen font-sans antialiased">
      ...
      <section className="relative bg-[#ffffff] text-gray-900 overflow-hidden min-h-[580px] lg:min-h-[680px] flex items-center border-b border-gray-100">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 py-12 lg:py-20 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center text-left">
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-3 bg-[#091e44] hover:bg-[#061632] text-white px-8 py-4 rounded-xl text-sm md:text-base font-bold tracking-wide shadow-lg shadow-[#091e44]/20 transition-all duration-300 hover:-translate-y-0.5"
              >
                <Phone size={18} />
          ...
          <div className="lg:col-span-7 relative aspect-[2/1] w-full rounded-3xl overflow-hidden shadow-2xl border border-gray-100 group lg:hidden block">
            ...
            <div className="absolute top-4 right-4 bg-[#091e44] rounded-2xl p-4 border border-white/10 shadow-2xl flex flex-col items-center justify-center text-center max-w-[125px] z-10">
      ...
      <section className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-[#091e44] rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 border border-white/5">
            ...
            <div className="flex flex-wrap gap-4 items-center justify-center shrink-0">
              <Link
                href="/contact"
                className="bg-[#C9922A] text-white px-7 py-3.5 rounded-xl text-sm font-bold tracking-wide shadow-lg shadow-[#C9922A]/10 transition-all duration-300 hover:bg-[#a6741b] hover:shadow-[#C9922A]/20 hover:-translate-y-0.5 inline-flex items-center gap-2"
              >
                Enquire Now
              </Link>
              <a
                href="tel:+916389088088"
                className="border border-[#C9922A] text-[#C9922A] px-7 py-3.5 rounded-xl text-sm font-bold tracking-wide transition-all duration-300 hover:bg-[#C9922A]/10 hover:-translate-y-0.5 inline-flex items-center gap-2"
              >
                <Phone size={16} />
                Call Now
              </a>
