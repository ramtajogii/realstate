          ...
          <div className="bg-[#091e44] rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 border border-white/5">
            ...
            <div className="flex flex-wrap gap-4 items-center justify-center shrink-0">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#25D366] text-white px-7 py-3.5 rounded-xl text-sm font-bold tracking-wide shadow-lg shadow-green-500/10 transition-all duration-300 hover:bg-[#20ba5a] hover:shadow-green-500/20 hover:-translate-y-0.5 inline-flex items-center gap-2"
              >
